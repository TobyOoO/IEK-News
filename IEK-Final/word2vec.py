...
def main(_):
	...
	'''if not FLAGS.train_data or not FLAGS.save_path:
		...
		sys.exit(1)'''
	topic_list_0 = ['文化創意經濟','食品安全','資訊透明.後隱私社會與私領域保障間的新挑戰問題','地緣經濟和地緣政治格局','失業或就業不穩定','國家間衝突.非政府行動者權力增加','生物多樣性的危機','重視生活品質的生活型態','產業結構兩極化','全球化挑戰的新管理形式','全球知識社會','全球責任共享','糧食安全','全球創新競賽中的新驅動者與行動者','災難危險','低成長與成長策略轉換','電子民主主義','嚴重社會動盪','跨國金融防弊','財政危機','地緣政治事件重塑許多區域的科學與技術發展','核能安全問題','能源與資源枯竭']
	topic_list_1 = ['製造業的革命','智慧世界的學習與工作','共享經濟','數位化驅動經濟與工作型態轉變','數位經濟發展','技術與創新的動態性','全球治理','大規模非自願移民','傳統家族概念的轉變','中國大陸與國安.統一問題','克服絕症.百歲時代','國家間環境影響增加','超連結社會','性別問題加劇','多元社會的歸屬感與獨特性','不均等問題','網路犯罪現象','與鄰國的領土糾紛','經濟和國家力量.中國再2030年將超越美國.債務增加限制國防支出','民眾作為研究與創新系統中的參與行動者','經濟成長新層次與界於永續性.社會富裕與生活品質中的平衡點','學歷中心之競爭性教育','地方永續發展','多元文化擴散','氣候變遷與自然災害','少子化與超高齡','未來世代生活的不安定性','文化創意經濟','食品安全','資訊透明.後隱私社會與私領域保障間的新挑戰問題','地緣經濟和地緣政治格局','失業或就業不穩定','國家間衝突.非政府行動者權力增加','生物多樣性的危機','重視生活品質的生活型態','產業結構兩極化','全球化挑戰的新管理形式','全球知識社會','全球責任共享','糧食安全','全球創新競賽中的新驅動者與行動者','災難危險','低成長與成長策略轉換','電子民主主義','嚴重社會動盪','跨國金融防弊','財政危機','地緣政治事件重塑許多區域的科學與技術發展','核能安全問題','能源與資源枯竭']
	topic_list = [ x+'_0' for x in topic_list_0] + [x+'_1' for x in topic_list_1]
	for topic in topic_list:
		...
		with open(FLAGS.train_data, 'r') as f:
                        ...
                        if len(set(content)) <= 3000: continue
                        #continue
                opts = Options()
